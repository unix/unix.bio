...
export const Btc = () => {
  ...
  return (
   <>
     <Button auto size="mini" type="secondary" onClick={() => setVisible(true)}>Show address of BTC</Button>
     <Modal {...bindings}>
...
export const Alipay = () => {
  ...
  return (
    <>
      <Button auto size="mini" type="secondary" onClick={() => setVisible(true)}>Show Alipay</Button>
      <Modal {...bindings}>
