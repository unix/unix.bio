...
如果你使用在此基础上构建的 UI 库 `@zeit-ui/react` 时发现任何瑕疵，那一定是我们拙劣的技术实现所致。
...
<Tabs initialValue="npm">
  <Tabs.Item label={<><Image scale="80%" width="38" height="18" src="/assets/npm.png" />NPM</>} value="npm">
    ...
    <Display width="500px" caption={<p>使用 <Code>npm</Code> 安装 UI 组件</p>}>
      <Snippet type="success">npm install @zeit-ui/react</Snippet>
    </Display>
  </Tabs.Item>
  <Tabs.Item label={<><Image width="45" height="18" src="/assets/yarn.png" />Yarn</>} value="yarn">
    <Display width="500px" caption={<p>使用 <Code>yarn</Code> 创建 React 应用</p>}>
    ...
    <Display width="500px" caption={<p>使用 <Code>yarn</Code> 安装 UI 组件</p>}>
      <Snippet type="success">yarn add @zeit-ui/react</Snippet>
    </Display>
  </Tabs.Item>
</Tabs>
...
<Display width="500px" shadow caption={<p>我们的第一个页面</p>}>
  <Image.Browser title="react-getting-started">
    <Image width={500} height={327} src="/assets/getting-started-demo-1.png" />
  </Image.Browser>
</Display>
