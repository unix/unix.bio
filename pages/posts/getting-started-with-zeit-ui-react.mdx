...
<Tabs initialValue="npm">
  <Tabs.Item
    label={
      <>
        <Image scale="80%" width="38" height="18" src="/assets/npm.png" />
        NPM
      </>
    }
    value="npm">
    ...
    <Text>
      安装成功后可运行 <Code>npm start</Code> 确认。现在只需要将 <Code>@zeit-ui/react</Code>{' '}
      组件库安装至项目即可：
    </Text>
    <Display
      width="500px"
  ...
  <Tabs.Item
    label={
      <>
        <Image width="45" height="18" src="/assets/yarn.png" />
        Yarn
      </>
    }
    value="yarn">
    ...
    <Text>
      安装成功后可运行 <Code>yarn start</Code> 确认。现在只需要将 <Code>@zeit-ui/react</Code>{' '}
      组件库安装至项目即可：
    </Text>
    <Display
      width="500px"
